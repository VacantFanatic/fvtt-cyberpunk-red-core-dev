...
| [docs/REGRESSION-TESTING.md](docs/REGRESSION-TESTING.md) | Template regression scripts and Foundry E2E smoke checklist for sheet/UI changes |
...
Every pull request must pass the steps in [AGENTS.md](AGENTS.md) (mirrored in [`.github/workflows/ci.yml`](.github/workflows/ci.yml)): `npm ci`, version sync between `package.json` and `src/system.json`, `npm run test:regression`, `npm run lint`, and `npm run build`. Sheet or template changes should also follow the [Foundry E2E checklist](docs/REGRESSION-TESTING.md#foundry-e2e-smoke-checklist).
