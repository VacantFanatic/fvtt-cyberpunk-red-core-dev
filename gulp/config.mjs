...
export const DISCORD_MESSAGE_CHANGELOG = `Check out the full CHANGELOG [here](https://github.com/cyberpunk-red-team/fvtt-cyberpunk-red-core/blob/${SYSTEM_VERSION}/CHANGELOG.md)\n\n`;
